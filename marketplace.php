...
<input type="submit" value="signup">
		...
		<h3 style="text-align: center; color: white;" id="marketplace">Top Trending</h3>
		<div class="container">
			<div class="row">
				<div class="col-sm-6">
				<h1>Trending now!</h1>
...
<?php require ("dbc.php");?>
<?php
$SQL = "SELECT Company_Name, Company_desc, Company_Category FROM Startup";
...
while($fetch = mysql_fetch_array($result)){
 ...
 $divHtml .='    <a style="margin-top: 10px;" href="#" class="btn btn-success">Read more</a>'; // be careful with this class, as you might need to evaluate it for every run of the loop
    $divHtml .='        </div>';
    $divHtml .='            </div>';
    $divHtml .='            </div>';
}
